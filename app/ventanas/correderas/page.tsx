...
const opciones = [
    {
        img: "/images-ventanas-windowConfigurator/corredera-slide.png",
        alt: "Ventana corredera premislide",
        title: "Ventana corredera premislide",
...
export default function VentanasCorrederasPage() {
    return (
        <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
                        ...
                        <div className="space-y-6 text-center md:text-left">
                            ...
                            <h2 className="text-lg sm:text-xl text-slate-600 font-light">
                                Deslizamiento suave con diseño de alta calidad.
                            </h2>

                            <p className="text-base text-slate-600 leading-relaxed">
                                Los sistemas deslizantes de KÖMMERLING optimizan el espacio y el confort interior mediante deslizamientos de alta calidad. Su diseño elegante y tecnológico garantiza durabilidad, siendo ideales para puertas de terraza y grandes aperturas.
                            </p>
                        ...
                        <div className="relative h-64 sm:h-80 md:h-96 rounded-sm overflow-hidden shadow-2xl">
                            <Image
                                src="/images-productsSection/image_productKommerling.webp"
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-gray-900">
                            Modelos con apertura corredera
                        </h2>
                        <p className="text-base text-gray-600 mt-2">
