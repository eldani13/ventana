...
export default function LilianaDiaz() {
  useEffect(() => {
  ...
  const downloadVCard = () => {
    const vcard = [
      ...
      "TEL;TYPE=WORK,VOICE:+573214091817",
      "EMAIL;TYPE=WORK:asesor1@nuvowin.com",
      "URL:https://nuvowin.com/tarjetas/liliana-diaz",
          ...
          <div className="pt-16 pb-6 px-6 text-center">
            ...
            <div className="space-y-3 text-left">
              ...
              >
                ...
                <span className="text-sm text-gray-700">+57 321 409 1817</span>
              </a>
...
function ShareModal({
  ...
  const onMail = (provider: "gmail" | "outlook") => {
    const subject = encodeURIComponent("Tarjeta de contacto - Liliana Diaz");
