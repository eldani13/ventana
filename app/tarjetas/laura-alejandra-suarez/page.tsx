...
export default function LauraAlejandraSuarez() {
  useEffect(() => {
  ...
  const downloadVCard = () => {
    const vcard = [
      "BEGIN:VCARD",
      "VERSION:3.0",
      "FN:Laura Alejandra Suarez",
      "ORG:NUVOWIN",
      "TITLE:Asesora Comercial",
      "TEL;TYPE=WORK,VOICE:+573005471945",
      "EMAIL;TYPE=WORK:asesor1@nuvowin.com",
      "URL:https://nuvowin.com/tarjetas/laura-alejandra-suarez",
    ...
    a.href = url;
    a.download = "laura-alejandra-suarez.vcf";
          ...
          <div className="pt-16 pb-6 px-6 text-center">
            ...
            <div className="space-y-3 text-left">
              ...
              >
                ...
                <span className="text-sm text-gray-700">+57 300 547 1945</span>
              </a>

              <a
                href="mailto:asesor1@nuvowin.com"
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-xl p-6 w-[320px] flex flex-col items-center">
        <h3 className="text-lg font-semibold mb-4">
          QR - Tarjeta Laura Alejandra Suarez
        </h3>
        <img
          src={qrUrl}
          alt="QR Laura Alejandra Suarez"
...
function ShareModal({
    ...
    if ((navigator as any).share) {
      try {
        await (navigator as any).share({
          title: "Tarjeta Laura Alejandra Suarez",
  ...
  const onMail = (provider: "gmail" | "outlook") => {
    const subject = encodeURIComponent("Tarjeta de contacto - Laura Alejandra Suarez");
