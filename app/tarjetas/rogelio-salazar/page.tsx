...
export default function RogelioSalazar() {
  useEffect(() => {
  ...
  const downloadVCard = () => {
    const vcard = [
      ...
      "FN:Rogelio Salazar",
      "ORG:NUVOWIN",
      "TITLE:Director de servicio",
      "TEL;TYPE=WORK,VOICE:+573115504794",
      "EMAIL;TYPE=WORK:asesor1@nuvowin.com",
      "URL:https://nuvowin.com/tarjetas/rogelio-salazar",
    ...
    a.href = url;
    a.download = "rogelio-salazar.vcf";
        ...
        <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="relative h-36">
            ...
            <div className="absolute left-1/2 -bottom-12 -translate-x-1/2 w-[110px] h-[110px] rounded-full border-4 border-white shadow-lg bg-gray-100 flex items-center justify-center overflow-hidden z-10">
              <Image src="/rogelio_profile.jpg" alt="Rogelio" width={120} height={120} />
            </div>
          </div>
          ...
          <div className="pt-16 pb-6 px-6 text-center">
            ...
            <p className="text-sm text-gray-500 mb-4">Director de servicio</p>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-xl p-6 w-[320px] flex flex-col items-center">
        <h3 className="text-lg font-semibold mb-4">
          QR - Tarjeta Rogelio Salazar
        </h3>
        <img
          src={qrUrl}
          alt="QR Rogelio Salazar"
...
function ShareModal({
  ...
  const onMail = (provider: "gmail" | "outlook") => {
    const subject = encodeURIComponent("Tarjeta de contacto - Rogelio Salazar");
