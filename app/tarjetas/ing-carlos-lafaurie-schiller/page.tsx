...
export default function IngCarlosLafaurieSchiller() {
  useEffect(() => {
  ...
  const downloadVCard = () => {
    ...
    a.href = url;
    a.download = "ing-carlos-lafaurie-schiller.vcf";
        ...
        <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="relative h-36">
            ...
            <div className="absolute left-1/2 -bottom-12 -translate-x-1/2 w-[110px] h-[110px] rounded-full border-4 border-white shadow-lg bg-gray-100 flex items-center justify-center overflow-hidden z-10">
              <Image src="/carlos_profile.jpg" alt="Carlos" width={120} height={120}/>
            </div>
          </div>

          <div className="pt-16 pb-6 px-6 text-center">
            <h2 className="text-lg font-semibold text-gray-800">
              Ing. Carlos Lafaurie Schiller
            </h2>
            <p className="text-sm text-gray-500 mb-4">Gerente Comercial</p>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-xl p-6 w-[320px] flex flex-col items-center">
        <h3 className="text-lg font-semibold mb-4">
          QR - Tarjeta Ing. Carlos Lafaurie Schiller
        </h3>
        <img
          src={qrUrl}
          alt="QR Ing. Carlos Lafaurie Schiller"
...
function ShareModal({
    ...
    if ((navigator as any).share) {
      try {
        await (navigator as any).share({
          title: "Tarjeta Ing. Carlos Lafaurie Schiller",
  ...
  const onMail = (provider: "gmail" | "outlook") => {
    const subject = encodeURIComponent("Tarjeta de contacto - Ing. Carlos Lafaurie Schiller");
