...
export default function VitalioSalgado() {
  useEffect(() => {
  ...
  const downloadVCard = () => {
    const vcard = [
      ...
      "TEL;TYPE=WORK,VOICE:+573135894565",
      "EMAIL;TYPE=WORK:asesor2@nuvowin.com",
      "URL:https://nuvowin.com/tarjetas/vitalio-salgado",
    ...
    a.href = url;
    a.download = "vitalio-salgado.vcf";
      ...
      <div className="w-full max-w-sm px-4">
        <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="pt-16 pb-6 px-6 text-center">
            ...
            <p className="text-sm text-gray-500 mb-4">Asesor Comercial</p>

            <div className="space-y-3 text-left">
              <a
                href="https://wa.me/573135894565"
              ...
              >
                ...
                <span className="text-sm text-gray-700">+57 313 589 4565</span>
              </a>

              <a
                href="mailto:asesor2@nuvowin.com"
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-white rounded-xl p-6 w-[320px] flex flex-col items-center">
        <h3 className="text-lg font-semibold mb-4">
          QR - Tarjeta Vitalio Salgado
        </h3>
        <img
          src={qrUrl}
          alt="QR Vitalio Salgado"
...
function ShareModal({
  ...
  const onMail = (provider: "gmail" | "outlook") => {
    const subject = encodeURIComponent("Tarjeta de contacto - Vitalio Salgado");
