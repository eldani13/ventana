...
export default function PuertasBalconerasPages() {
    return (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
                        ...
                        <div className="space-y-6 text-center md:text-left">
                            ...
                            <h2 className="text-lg sm:text-xl text-slate-600 font-light">
                                Seguridad y aislamiento para su hogar.
                            </h2>

                            <p className="text-base text-slate-600 leading-relaxed">
                                Estos sistemas, ideales por su variedad de combinaciones y complementos, son perfectos para puertas de entrada en patios y jardines, así como para terrazas o balcones que requieran buen aislamiento.
                            </p>
