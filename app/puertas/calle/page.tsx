...
export default function PuertasCallePages() {
    return (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
                        ...
                        <div className="space-y-6 text-center md:text-left">
                            ...
                            <p className="text-base text-slate-600 leading-relaxed">
                                Las puertas de calle, de alta resistencia, se adaptan a diversas necesidades y permiten personalizarse con paneles decorativos, vidrios y tiradores.
                            </p>
