...
export default function QuoteForm() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description:
          "Hubo un problema al enviar tu cotización. Por favor intenta de nuevo.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  return (
    <main
      id="cotizacion"
      className="min-h-screen bg-[#fbfcfc] flex items-center justify-center py-16 px-4"
    >
      <section className="max-w-7xl w-full">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#7b7a7d] max-w-2xl mx-auto">
            Completa el formulario y recibe una propuesta personalizada en menos
            de 24 horas
          </p>
        </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-5 border border-blue-100">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">
                    ...
                    contacto contigo para proporcionarte la información
                    solicitada sobre nuestros productos y servicios.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              ...
              <div className="mb-6 pb-6 border-b border-gray-200">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#4a4a49] mb-2">
                      Sede Barranquilla
                    </h3>
              ...
              <div className="mb-4">
                <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:contacto@homeglass.com.co"
                      className="text-[#0b72ba] hover:text-[#2b91cf] font-semibold"
                    >
              ...
              <div>
                <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-[#0b72ba] font-semibold">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100 text-center">
            ...
            <p className="text-sm text-gray-600">
              Te contactamos en menos de un día hábil
            </p>
          </div>
