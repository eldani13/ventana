...
export default function Navbar() {
  ...
  const [activeVentanasSection, setActiveVentanasSection] = useState<
    "abatibles" | "correderas" | ""
  >("");
  const [activePuertasSection, setActivePuertasSection] = useState<
    "calle" | "balconeras" | "correderas" | "especiales" | ""
  >("");
  const [activePersianasSection, setActivePersianasSection] = useState<
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                      ...
                      {activeVentanasSection === "abatibles" ? (
                        <>
                          <div className="mb-6">
                            ...
                            <p className="text-base text-slate-600 max-w-2xl leading-relaxed">
                              Los sistemas de ventanas más aislantes de
                              KÖMMERLING. Consiga hasta un 70% de ahorro de
                              pérdidas energéticas en calefacción y aire
                              acondicionado. Esta forma de apertura es ideal
                              para proporcionar aislamiento térmico y acústico,
                              al tiempo que facilitan tareas como la ventilación
                              o la limpieza de los elementos acristalados.
                            </p>
                          </div>
                          <div className="grid grid-cols-3 gap-8 divide-x divide-gray-100 flex-1">
                            <div className="flex flex-col items-start px-6">
                              ...
                              <ul className="space-y-3">
                                <li className="flex items-center gap-2 text-slate-700 font-medium">
                                  <Image
                                    src="/images-ventana-navbar/System-Basic-58-Standard_web.png"
                                    width={40}
                                    height={40}
                                    alt="EuroFine58"
                                    className="inline-block mr-1 w-8"
                                  />
                                  EuroFine58
                                </li>
                                <li className="flex items-center gap-2 text-slate-700 font-medium">
                                  <Image
                                    src="/images-ventana-navbar/sistema_glasswin_0_1_0.png"
                                    width={40}
                                    height={40}
                                    alt="EuroFine58"
                                    className="inline-block mr-1 w-8"
                                ...
                                <li className="flex items-center gap-2 text-slate-700 font-medium">
                                  <Image
                                    src="/images-ventana-navbar/sistema-kommerling76-ad-xtrem.png"
                                    width={40}
                                    height={40}
                                    alt="EuroFine58"
                                    className="inline-block mr-1 w-8"
                            ...
                            <div className="flex flex-col items-start px-6">
                              ...
                              <ul className="space-y-3">
                                <li className="flex items-center gap-2 text-slate-700 font-medium">
                                  <Image
                                    src="/images-ventana-navbar/ventana-oscilobatiente_0.png"
                                    width={40}
                                    height={40}
                                    alt="EuroFine58"
                                    className="inline-block mr-1 w-8"
                                ...
                                <li className="flex items-center gap-2 text-slate-700 font-medium">
                                  <Image
                                    src="/images-ventana-navbar/ventana-abatible-horizontal.png"
                                    width={40}
                                    height={40}
                                    alt="EuroFine58"
                                    className="inline-block mr-1 w-8"
                                ...
                                <li className="flex items-center gap-2 text-slate-700 font-medium">
                                  <Image
                                    src="/images-ventana-navbar/ventana-abatible_0.png"
                                    width={40}
                                    height={40}
                                    alt="EuroFine58"
                                    className="inline-block mr-1 w-8"
                        ...
                        <>
                          <div className="mb-6">
                            ...
                            <p className="text-base text-slate-600 max-w-2xl leading-relaxed">
                              Con los sistemas deslizantes de KÖMMERLING se
                              logra optimizar al máximo el espacio y confort
                              interior del hogar con deslizamientos de calidad.
                              Diseños elegantes y cuidados con la última
                              tecnología para garantizar su durabilidad. Estos
                              sistemas son ideales para puertas de terraza.
                            </p>
                          </div>
                          <div className="grid grid-cols-3 gap-8 divide-x divide-gray-100 flex-1">
                            <div className="flex flex-col items-start px-6">
                              ...
                              <ul className="space-y-3">
                                <li className="flex items-center gap-2 text-slate-700 font-medium">
                                  <Image
                                    src="/images-ventana-navbar/premiline58.png"
                                    width={40}
                                    height={40}
                                    alt="PremiLine58"
                                    className="inline-block mr-1 w-8"
                                ...
                                <li className="flex items-center gap-2 text-slate-700 font-medium">
                                  <Image
                                    src="/images-ventana-navbar/sistema_premislide76.png"
                                    width={40}
                                    height={40}
                                    alt="PremiSlide76"
                                    className="inline-block mr-1 w-8"
                                ...
                                <li className="flex items-center gap-2 text-slate-700 font-medium">
                                  <Image
                                    src="/images-ventana-navbar/sistema_premiline.png"
                                    width={40}
                                    height={40}
                                    alt="PremiLine"
                                    className="inline-block mr-1 w-8"
                            ...
                            <div className="flex flex-col items-start px-6">
                              ...
                              <ul className="space-y-3">
                                <li className="flex items-center gap-2 text-slate-700 font-medium">
                                  <Image
                                    src="/images-ventana-navbar/corredera-slide.png"
                                    width={40}
                                    height={40}
                                    alt="Corredora premislide"
                                    className="inline-block mr-1 w-8"
                                  />
                                ...
                                <li className="flex items-center gap-2 text-slate-700 font-medium">
                                  <Image
                                    src="/images-ventana-navbar/Corredera.png"
                                    width={40}
                                    height={40}
                                    alt="Corredora tradicional"
                                    className="inline-block mr-1 w-8"
                                  />
                ...
                <div className="w-screen mx-auto px-6 py-6 relative">
                  <div className="grid grid-cols-[auto_1fr] gap-0 bg-gray-50 rounded-lg border border-gray-200">
                      ...
                      <nav className="flex flex-col gap-0 text-base font-sans">
                        {[
                          ...
                          <Link
                            ...
                            href={href as string}
                            onMouseEnter={() =>
                              setActivePuertasSection(key as any)
                            }
                    ...
                    <div
                      ...
                      onMouseLeave={() => setActivePuertasSection("calle")}
                    >
                      {activePuertasSection === "calle" && (
                        <>
                          <div className="mb-6">
                            ...
                            <p className="text-base text-gray-700 max-w-3xl">
                              Las puertas de calle con sistemas KÖMMERLING de
                              alta resistencia ofrecen una amplia variedad de
                          ...
                          <div className="grid grid-cols-3 gap-10 divide-x divide-gray-200 flex-1">
                            <div className="space-y-3 px-6">
                              ...
                              <ul className="flex items-center gap-2 text-base text-gray-700 space-y-2">
                                <Image
                                  src="/images-puertas-navbar/puerta-calle-kommerling76-xtrem.png"
                                  width={40}
                                  height={40}
                                  alt="EuroFine58"
                            ...
                            <div className="space-y-3 px-6">
                              ...
                              <ul className="flex items-center gap-2 text-base text-gray-700 space-y-2">
                                <Image
                                  src="/images-puertas-navbar/apertura_puerta_calle.png"
                                  width={40}
                                  height={40}
                                  alt="EuroFine58"
                                  className="inline-block mr-1 w-6"
                      ...
                      {activePuertasSection === "balconeras" && (
                        <>
                          <div className="mb-6">
                            ...
                            <p className="text-base text-gray-700 max-w-3xl">
                              Estos sistemas son ideales, al permitir gran
                              variedad de combinaciones y otros complementos,
                              para puertas de entrada en patios y zonas
                              ajardinadas. También son muy adecuadas para
                              terrazas o balcones cuando queremos mantener un
                      ...
                      {activePuertasSection === "correderas" && (
                        <>
                          <div className="mb-6">
                            ...
                            <p className="text-base text-gray-700 max-w-3xl">
                              KÖMMERLING es especialista en este tipo de
                              cerramiento con sistemas deslizantes donde combina
                              diseño y prestaciones técnicas.
                            </p>
                          </div>
                          <div className="grid grid-cols-3 gap-10 divide-x divide-gray-200 flex-1">
                            <div className="space-y-3 px-6">
                              ...
                              <ul className="space-y-2 text-base text-gray-700">
                                ...
                                <li className="flex items-center gap-2">
                                  <Image
                                    src="/images-ventana-navbar/trocal-premidoor-76-standard-weiss.png"
                                    width={40}
                                    height={40}
                                    alt="PremiDoor76"
                                    className="inline-block mr-1 w-6"
                            ...
                            <div className="space-y-3 px-6">
                              ...
                              <ul className="space-y-2 text-base text-gray-700">
                                <li className="flex items-center gap-2">
                                  <Image
                                    src="/images-ventana-navbar/corredera_0.png"
                                    width={40}
                                    height={40}
                                    alt="Corredera premislide"
                                    className="inline-block mr-1 w-6"
                                  />
                                  Corredera premislide
                                </li>
                                ...
                                <li className="flex items-center gap-2">
                                  <Image
                                    src="/images-ventana-navbar/ventana-elevadora.png"
                                    width={40}
                                    height={40}
                                    alt="Corredera elevadora"
                                    className="inline-block mr-1 w-6"
                                  />
                                  Corredera elevadora
                                </li>
                      ...
                      {activePuertasSection === "especiales" && (
                        <>
                          <div className="mb-6">
                            ...
                            <p className="text-base text-gray-700 max-w-3xl">
                              Las aperturas especiales combinan perfiles
                              practicables con herrajes que permiten un
                              cerramiento deslizante sin renunciar a unas buenas
                              prestaciones. Solución ideal para espectaculares
                              ...
                              <ul className="space-y-2 text-base text-gray-700">
                                <li className="flex items-center gap-2">
                                  <Image
                                    ...
                                    width={40}
                                    height={40}
                                    alt="KÖMMERLING76 Xtrem especiales"
                                    className="inline-block mr-1 w-6"
                                  />
                                  KÖMMERLING76 Xtrem especiales
                                </li>
                              </ul>
                            </div>
                            <div className="space-y-3 px-6">
                ...
                <div className="w-screen mx-auto px-6 py-6 relative">
                  <div className="grid grid-cols-[auto_1fr] gap-0 bg-gray-50 rounded-lg border border-gray-200">
                      ...
                      <nav className="flex flex-col gap-0 text-base font-sans">
                        {[
                          ...
                          <Link
                            ...
                            href={href as string}
                            onMouseEnter={() =>
                              setActivePersianasSection(key as any)
                            }
                            onFocus={() =>
                              setActivePersianasSection(key as any)
                            }
                    ...
                    <div
                      className="flex flex-col h-full p-10"
                      onMouseLeave={() =>
                        setActivePersianasSection("persianas")
                      }
                    >
                      {activePersianasSection === "persianas" && (
                        <>
                          <div className="mb-6">
                            ...
                            <p className="text-base text-gray-700 max-w-3xl">
                              La persiana capaz no sólo de mantener sino mejorar
                              ...
                              cualquier ventana. El sistema de persianas
                              RolaPlus es el único recomendado por KÖMMERLING ya
                              que es capaz de mantener y hasta reforzar los
                              niveles de aislamiento del cerramiento.
                              <br />
                              Confirme siempre con su instalador de la Red
                              Oficial KÖMMERLING que la persiana que le instalan
                              con sus ventanas es RolaPlus.
                            </p>
                          </div>
                          <div className="grid grid-cols-3 gap-10 divide-x divide-gray-200 flex-1">
                            <div className="space-y-3 px-6">
                              ...
                              <ul className="flex items-center gap-2 text-base text-gray-700 space-y-2">
                                <Image
                                  src="/images-persianas-navbar/presiana-rolaplus-trans_0.png"
                                  width={40}
                                  height={40}
                                  alt="Sistema RolaPlus"
                                  className="inline-block mr-1 w-6"
                                />
                      ...
                      {activePersianasSection === "contraventanas" && (
                        <>
                          <div className="mb-6">
                            ...
                            <p className="text-base text-gray-700 max-w-3xl">
                              Contamos con diferentes tipos de contraventanas
                              que aportan claros beneficios a la vivienda,
                              protegiendo las ventanas frente las duras
                              condiciones climatológicas y dándoles un toque de
                              personalidad. Además, su mantenimiento es mínimo y
                          ...
                          <div className="grid grid-cols-3 gap-10 divide-x divide-gray-200 flex-1">
                            <div className="space-y-3 px-6">
                              ...
                              <ul className="space-y-2 text-base text-gray-700">
                                <li className="flex items-center gap-2">
                                  <Image
                                    src="/images-ventana-navbar/contraventana_lider.png"
                                    width={40}
                                    height={40}
                                    alt="Sistema Líder"
                                    className="inline-block mr-1 w-6"
                            ...
                            <div className="space-y-3 px-6">
                              ...
                              <ul className="space-y-2 text-base text-gray-700">
                                <li className="flex items-center gap-2">
                                  <Image
                                    src="/images-ventana-navbar/frailero.png"
                                    width={40}
                                    height={40}
                                    alt="Sistema Frailero"
                                    className="inline-block mr-1 w-6"
                                  />
                                  Sistema Frailero
                                </li>
        ...
        >
          <div className="flex flex-col gap-2 py-4 border-t">
            ...
            {/* Ventanas */}
            <div className="rounded-lg overflow-hidden shadow-sm  mx-2">
              <button
                onClick={() => {
                  setVentanasOpen(!ventanasOpen);
                  setActivePuertasSection("");
                  setActivePersianasSection("");
                }}
              ...
              >
                <Link
                  ...
                  className="block font-semibold text-blue-700 py-2 px-2 rounded hover:bg-blue-50 transition-colors duration-200"
                >
                  Ventanas abatibles
                </Link>
                <Link
            ...
            <div className="rounded-lg overflow-hidden shadow-sm  mx-2">
              <button
                onClick={() => {
                  setActivePuertasSection(
                    activePuertasSection === "calle" ? "" : "calle"
                  );
                  setVentanasOpen(false);
                  setActivePersianasSection("");
                }}
            ...
            <div className="rounded-lg overflow-hidden shadow-sm  mx-2">
              <button
                onClick={() => {
                  setActivePersianasSection(
                    activePersianasSection === "persianas" ? "" : "persianas"
                  );
                  setVentanasOpen(false);
                  setActivePuertasSection("");
                }}
            ...
            <Link
              href="#contacto"
              className="text-gray-700 hover:text-blue-600 font-medium px-4 py-2 rounded-md hover:bg-blue-50 transition-colors duration-200 mx-2"
            >
              Contacto
            </Link>
            ...
            <Button
              asChild
              className="bg-blue-600 hover:bg-blue-700 w-[calc(100%-1rem)] mx-auto mt-2 transition-all duration-200 shadow-md rounded-lg"
            >
              <a href="#cotizacion">Solicitar Cotización</a>
            </Button>
          </div>
